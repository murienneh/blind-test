...
class PubliciteViewController: UIViewController {
    ...
    //Une fois le décompte terminé on lance la partie, envoi sur la page PubliciteQuestionViewController
    func demarrerQuizz(){
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let publiciteQuestionsViewController = storyboard.instantiateViewController(withIdentifier: "PubliciteQuestionsViewController") as! PubliciteQuestionsViewController
        publiciteQuestionsViewController.tempsRep = tempsRep
        self.navigationController?.pushViewController(publiciteQuestionsViewController, animated: true)
    }
